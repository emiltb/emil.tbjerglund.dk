...
knitr::kable(head(dataset, 4), caption = "The mtcars dataset contain data on 32 different cars")
```
...
In the long run I am confident that the extra workload that must be put into making a well-crafted R package will pay off, once the scientific analysis can be performed more efficient and reproducibly by every member of our research group. 
